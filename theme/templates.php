...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> +250 782 722 026</a></li>
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root?>"><img src="images/home/logoo.png" alt="" /></a>
            </div> 
          </div>
    ...
    <div class="footer-top">
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-3">
            <div class="address">
              <img src="images/home/mapkgtown.png" alt="" />
              <p>Rwanda, Kigali, Down Town, K67</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-sm-3">
            <div class="single-widget">
              ...
              <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="index.php?q=cart">Order Status</a></li>
                <li><a href="customer/profile.php">Change Location</a></li>
          ...
          <div class="col-sm-3">
            <div class="single-widget">
              ...
              <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="index.php?q=product">Our Products</a></li>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">Modified by <span><a href="https://www.kodagirls.rw">Koda</a></span></p>
        </div>
      </div>
    </div>
