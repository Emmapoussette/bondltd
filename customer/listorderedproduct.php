				 ...
				 $subtot=0;
				  $query = "SELECT * 
						...
						echo '<tr>';  
				  		...
				  		echo '<td> RWF '. number_format($result->PROPRICE,2).' </td>';
				  		echo '<td align="center" >'. $result->ORDEREDQTY.'</td>';
				  		?>
				  		 <td> RWF <output><?php echo  number_format($result->ORDEREDPRICE,2); ?></output></td> 
				  		<?php
		...
		?>
 		...
 		<div class="row">
		  	...
		  	<div class="col-md-6 pull-right">
		  		<p align="right">Total Price : RWF <?php echo number_format($subtot,2);?></p>
		  		<p align="right">Delivery Fee : RWF <?php echo number_format($price,2); ?></p>
		  		<p align="right">Overall Price : RWF <?php echo number_format($cur->PAYMENT,2); ?></p>
		  	</div>
		  </div>
		  ...
		  ?>
		   <hr/> 
		  <div class="row">
		 		 <p>Print or save this as a proof of payment</p><br/>
		  	  <p>We hope you enjoy your oreder products. Have a nice day!</p>
		  	  <p>Sincerely.</p>
		  	  <h4><a href="https://www.kodagirls.rw">C&D Bond Ltd with Koda</a></h4>
		  </div>
		  <?php }?>
  </div> 
